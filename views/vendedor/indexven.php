...
if((isset($_SESSION['usuario']))&&($_SESSION['usuario']['tipo']==1)){
    ...
    <body class="bg-grey">
        ...
        <ul class="collapse list-unstyled" id="Pedidos">
          ...
          <li>
            ...
            <li>
              ...
              <li>
                <a href="./views/cargar.php">Cargar nuevos</a>
              </li>
              <li>
                <a href="#">Modificar/Eliminar</a>
              </li>
      ...
      <section class="container container-index">
        <div class="row">
          <div class="col-12">
            <h5 class="mt-3 titulo-categoria"><b>MIS PRODUCTOS</b></h5>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row display-footer">
            ...
            <div class="col-12 col-md-5 col-lg-4 display-footer">
              <p class="slogan-footer">Todos los precios de <br> en un sólo lugar.</p>
            </div>
