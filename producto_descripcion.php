      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-4 col-sm-4 col-md-3 col-lg-2">
            <a href="index.php"><img class="logo-navbar" src="assets/img/logo-comidaya-white.png" alt=""></a>
          </div>
            ...
            <div class="col-6">
              <div class="row">
                ...
                <div class="col-12 col-md-6">
                  ...
                  <p class="descripcion-dscp">Precio promedio</p>
      ...
      <div class="col-6 col-md-4 col-lg-3 col-xl-2">
        <div class="card card-hover my-3 p-3">
          <a class="mb-3" href="#">
            ...
            <p class="descripcion">Precio promedio</p>
          </a>
