...
<body class="bg-grey">
        ...
        <div class="card card-shadow d-flex align-items-center">
          ...
          <div class="row">
            <div class="col-12">
              ...
              <p class="title-login mt-4">Te enviamos un correo para validar tu cuenta <br> Ya estas a un paso de empezar ahorrar</p>
  ...
  <script>
  setTimeout("location.href = 'landing.php';",5000);
  </script>
