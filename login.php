...
if($_POST){
  ...
  if (!$error) {
    ...
    if (isset($usuario) && $usuario['condition']==0 && !isset($noExiste1)) {
      $noExiste1 = 'Active su cuenta para iniciar Sesión';
    }
              ...
              <form class="" action="login.php" method="post">
                <div class="row">
                  ...
                  <div class="col-12 d-flex justify-content-center">
                    <input class="form-control" type="email" name="email" value="<?= $_POST['email']?> " placeholder="Email">
                  </div>
                  ...
                  <div class="col-12 d-flex justify-content-center">
                    <input class="form-control" type="password" name="password" value="<?= $_POST['password']?>" placeholder="Contraseña">
                  </div>
                  <div class="col-12 mb-2" style="color: #e03232; background-color: color: #f8d7da;">
                    <?=$error['password'] ?? '' ?>
                  </div>
                  ...
                  <div class="col-12 d-flex justify-content-center">
                    <button class="btn-ingresar btn-lg" type="submit" name="button">Ingresar</button>
                  </div>
